...
function Navbar() {
  ...
  return (
    <>
      ...
      >
        {/* Reduced vertical padding on small screens: py-3 (mobile) -> sm:py-6 (desktop) */}
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 sm:px-6 py-3 sm:py-6">
          ...
          <motion.div
            ...
            transition={{ type: "spring", stiffness: 200 }}
          >
            {/* smaller logo on mobile (h-12 w-12), larger on sm+ (h-20 w-20) */}
            <img
              src={logo}
              alt="GK Logo"
          ...
          {/* Right Side Icons */}
          {/* icon size slightly reduced on small screens: text-2xl -> sm:text-3xl */}
          <div className="hidden sm:flex items-center gap-6 text-2xl sm:text-3xl">
            {[
              { icon: <BsTwitterX />, link: "https://x.com/Gururajkondagul" },
          ...
          {/* Mobile Menu Button */}
          {/* smaller icon size on mobile: text-2xl */}
          <button
